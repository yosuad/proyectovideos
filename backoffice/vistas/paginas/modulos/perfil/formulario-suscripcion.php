    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h5 class="m-0 text-uppercase text-secondary">
                <strong>
                    Suscripcion Mensual $ 10
                </strong>
            </h5>
        </div>
        <div class="card-body">
            <h6 class="card-title"> ¡ Acceso sin Liminte! </h6>
            <br>
            <p class="card-texto"> Al activar su menbresia mensual e ingresa a nuestro programa
                de afiliados, el cual podra generar ingresos estra por referir afiliados.
                <br>
                para mas informacion ingrese a la pagina.
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" class="form-control" id="inputName" value="ensayo@correo.com" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" class="form-control" id="inputName" value="patrocinador-ensayo" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <span>
                    (Compartiendo este enlace podra ganar comision por afiliado, más información:
                    <a href="plan-compensacion"> Plan Compensación </a>)
                </span>
                ...
                <div class="col-sm-offset-2">
                    <div class="checkbox">
                        ...
                        <label for="aceptarTerminos">
                            <span></span> Yo Acepto y Firmo los <a href="#terminos"
                        ...
                        <a href="#terminos"data-toggle="collapse">
                            <span class="float-left float-xl-right text-info">
                                <b>
                                    Ver y Firmar Términos y Condiciones
                                </b>
                            </span>
